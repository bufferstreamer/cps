package com.cps.web.controller.demo.controller;

import com.alibaba.fastjson.JSON;
import com.cps.common.core.domain.AjaxResult;
import com.cps.common.core.domain.CxSelect;
import com.cps.common.json.JSONObject;
import com.cps.common.json.JSONObject.JSONArray;
...
public class DemoFormController {
    ...
    public AjaxResult collection() {
        String[] array = {"cps 1", "cps 2", "cps 3", "cps 4", "cps 5"};
        AjaxResult ajax = new AjaxResult();
